...
**Skills**: `nextjs-best-practices`, `react-best-practices`, `vuejs-patterns`, `angular-ui-patterns`, `tailwind-design-system`, `app-list`, `app-create`, `app-show`, `app-edit`, `app-button`, `refine-framework`, `ui-skills`, `frontend-design`.
